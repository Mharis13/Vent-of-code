...
public class Day03 {
    ...
    public static void main(String[] args) throws Exception {
        List<String> lines = Files.readAllLines(Paths.get(Day03.class.getResource("input03.txt").toURI()));
    ...
    public static long findGearRatios(Schematic schematic) {
        Map<Coord, List<Long>> gearsAndParts = new HashMap<Day03.Coord, List<Long>>();
