...
public class prueba {
    ...
    public static void main(String[] args) throws Exception {
        List<String> lines = Files.readAllLines(Paths.get(prueba.class.getResource("input01.txt").toURI()));

        System.out.println("Part 1: " + lines.stream().mapToLong(prueba::parseNumber).sum());

        System.out.println("Part 2: " + lines.stream()
                .map(prueba::mapAlphabeticNumbers)
                .mapToLong(prueba::parseNumber)
                .sum());
    }
